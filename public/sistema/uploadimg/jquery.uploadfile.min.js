...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            uploadStr:"Upload",
            abortStr: "Abortar",
            cancelStr: '<i class="fa fa-trash"></i>',
            deleteStr: "Eliminar",
            doneStr: "Listo",
            ...
            if($.fn.ajaxForm) {
                ...
                $(obj).append(obj.errorLog);
   				...
   				if(s.showQueueDiv)
		            ...
		            obj.container = $("<div class='row'></div>").insertAfter($(obj));
	...
	this.enqueueFile = function(file){
        ...
        function serializeAndUploadFiles(s, obj, files) {
            for(var i = 0; i < files.length; i++) {
				...
				pd.filename.html(fileNameStr.substring(0, 11)+"...");
		...
		function defaultProgressBar(obj,s)
		{
			...
			this.statusbar = $("<div class='col-md-4'></div>");
            this.preview = $("<img class='img-fluid rounded margen-btom' />").width(s.previewWidth).height(s.previewHeight).appendTo(this.statusbar).hide();
            this.filename = $("").appendTo(this.statusbar);
            this.progressDiv = $("<div class='ajax-file-upload-progress'>").appendTo(this.statusbar).hide();
            this.progressbar = $("<div class='ajax-file-upload-bar'></div>").appendTo(this.progressDiv);
            this.abort = $("").appendTo(this.statusbar).hide();
            this.cancel = $("<div>" + s.cancelStr + "</div>").appendTo(this.statusbar).hide();
            this.done = $("<div>" + s.doneStr + "</div>").appendTo(this.statusbar).hide();
            this.download = $("<div>" + s.downloadStr + "</div>").appendTo(this.statusbar).hide();
            this.del = $("<div>" + s.deleteStr + "</div>").appendTo(this.statusbar).hide();

            this.abort.addClass("btn btn-danger btn-block");
            this.done.addClass("btn btn-success");
			this.download.addClass("btn btn-success");
            this.cancel.addClass("btn btn-danger btn-block");
            this.del.addClass("btn btn-danger btn-block");
