                                ...
                                <form id="perfilvalidate">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Nombre</label>
                                                <input type="text" class="form-control" id="snombre" name="snombre" value="<?=$this->user[0]->nombre;?>" required="true">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Apellido</label>
                                                <input type="text" class="form-control" id="sapellido" name="sapellido" value="<?=$this->user[0]->apellido;?>" required="true">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>E-mail</label>
                                                <input type="email" class="form-control" id="semail" name="semail" value="<?=$this->user[0]->email;?>" required="true" email="true">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" id="password1" name="password1" placeholder="Contraseña" required="true">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Re ingresar contraseña</label>
                                                <input type="password" class="form-control" id="password2" name="password2" placeholder="Re ingresar contraseña" required="true">
                                            </div>
                                        </div>
                                    </div>
                                    <div id="mjs"></div>
